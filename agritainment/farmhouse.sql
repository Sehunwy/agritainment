...
CREATE TABLE `farm` (
  ...
  KEY `areaId` (`areaId`),
  KEY `picId` (`picId`),
  CONSTRAINT `farm_ibfk_1` FOREIGN KEY (`picId`) REFERENCES `picture` (`picId`),
  CONSTRAINT `farm_ibfk_2` FOREIGN KEY (`areaId`) REFERENCES `areas` (`areaid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of farm
-- ----------------------------
INSERT INTO `farm` VALUES ('1', '乐逍遥', '110101', '风景优美', '风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美风景优美', '200.00', '1', '123121212', '乐逍遥@163.com');
INSERT INTO `farm` VALUES ('2', '逍遥', '110102', '风景优美', '风景优美', '160.00', '1', '88-99999-99', '逍遥@163.com');
INSERT INTO `farm` VALUES ('3', '乐乐', '110103', '风景优美', '风景优美', '400.00', '1', '1232323231', '乐乐@163.com');
INSERT INTO `farm` VALUES ('4', '了', '110105', '风景优美', '风景优美', '100.00', '1', '000-000-00', '了@163.com');
INSERT INTO `farm` VALUES ('5', '笑笑', '110104', '风景优美', '风景优美', '200.00', '1', '11-11-11', '笑笑@163.com');
INSERT INTO `farm` VALUES ('6', '大大', '110106', '风景优美', '风景优美', '326.00', '1', '1111-87782-22', '大大@163.com');

-- ----------------------------
-- Table structure for pcuser
-- ----------------------------
DROP TABLE IF EXISTS `pcuser`;
CREATE TABLE `pcuser` (
  `pcId` int(4) NOT NULL AUTO_INCREMENT,
  `pcName` char(20) NOT NULL,
  `pcPw` varchar(255) NOT NULL,
  PRIMARY KEY (`pcId`),
...
-- Records of pcuser
-- ----------------------------
INSERT INTO `pcuser` VALUES ('1', '12345324354', '6512bd43d9caa6e02c990b0a82652dca');
INSERT INTO `pcuser` VALUES ('2', '11', '698d51a19d8a121ce581499d7b701668');
...
-- Records of picture
-- ----------------------------
INSERT INTO `picture` VALUES ('1', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1537880545105&di=ba9952dfeae8ce15fb5924fa3018a078&imgtype=0&src=http%3A%2F%2Fimg.52njl.net%2FImage%2Fyuantu%2Fguanggao%2F2015%2F03%2F20150324164834754369.jpg', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1537880545104&di=f1389891cbf1418638146323163ebe9e&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimage%2Fc0%253Dpixel_huitu%252C0%252C0%252C294%252C40%2Fsign%3Dd20c600270f40ad101e9cfa33e5474b3%2F7acb0a46f21fbe09b314942e60600c338744ad46.jpg', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1537880545103&di=c03b37113298b7943ebd9b30c467ae47&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimage%2Fc0%253Dpixel_huitu%252C0%252C0%252C294%252C40%2Fsign%3D3e440e3ca7af2eddc0fc41a9e4686485%2Ff11f3a292df5e0fed168f93b576034a85edf7293.jpg', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1537880545101&di=153d4df107e9ed5104782d265753676b&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimage%2Fc0%253Dpixel_huitu%252C0%252C0%252C294%252C40%2Fsign%3Da30b717209087bf469e15fa99bab3240%2Fd6ca7bcb0a46f21f0097106afd246b600c33ae6c.jpg', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1537880545100&di=ba1fcba152951f63d3d5fb9287338710&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimage%2Fc0%253Dpixel_huitu%252C0%252C0%252C294%252C40%2Fsign%3D98f2bd0a788da9775a228e6bd9299d75%2F63d9f2d3572c11df7b8ec11a682762d0f703c2a8.jpg');
...
CREATE TABLE `wechatuser` (
  `wechatId` int(4) NOT NULL AUTO_INCREMENT,
  `wechatName` char(20) NOT NULL,
  `wechatPw` char(20) NOT NULL,
